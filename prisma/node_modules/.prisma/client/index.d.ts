...
export namespace Prisma {
  ...
  */
  ...
  type GetChoreGroupByPayload<T extends ChoreGroupByArgs> = Promise<
    Array<
  ...
  export type ChoreGetPayload<
    S extends boolean | null | undefined | ChoreArgs,
    U = keyof S
      > = S extends true
        ? Chore
    : S extends undefined
    ? never
    : S extends ChoreArgs | ChoreFindManyArgs
    ?'include' extends U
    ? Chore 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof Chore ?Chore [P]
  : 
     never
  } 
    : Chore
  ...
  export interface ChoreDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Chore'> extends True ? CheckSelect<T, Prisma__ChoreClient<Chore>, Prisma__ChoreClient<ChoreGetPayload<T>>> : CheckSelect<T, Prisma__ChoreClient<Chore | null >, Prisma__ChoreClient<ChoreGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Chore'> extends True ? CheckSelect<T, Prisma__ChoreClient<Chore>, Prisma__ChoreClient<ChoreGetPayload<T>>> : CheckSelect<T, Prisma__ChoreClient<Chore | null >, Prisma__ChoreClient<ChoreGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Chore>>, PrismaPromise<Array<ChoreGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__ChoreClient<Chore>, Prisma__ChoreClient<ChoreGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends ChoreAggregateArgs>(args: Subset<T, ChoreAggregateArgs>): PrismaPromise<GetChoreAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, ChoreGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetChoreGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   */
  export class Prisma__ChoreClient<T> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   * Chore findUnique
   */
  export type ChoreFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a Chore can't be found
     * 
    **/
   ...
   * Chore findFirst
   */
  export type ChoreFindFirstArgs = {
    /**
     * Select specific fields to fetch from the Chore
     * 
    **/
  ...
  export type ChoreWhereInput = {
    ...
    dueDay?: StringFilter | string
    iconName?: StringFilter | string
  ...
  export type ChoreScalarWhereWithAggregatesInput = {
    ...
    dueDay?: StringWithAggregatesFilter | string
    iconName?: StringWithAggregatesFilter | string
  ...
  export type ChoreUpdateInput = {
    ...
    dueDay?: StringFieldUpdateOperationsInput | string
